...
\[
\log_{10}\!\left(\tau^R / \text{s}\right) \approx 10^{122},
\]
...
This is a small conceptual toolkit intended for:

- Teaching / outreach in cosmology and quantum gravity
- Back-of-the-envelope estimates where “cosmic IR and UV limits” are handy
- Occasionally, for humor in serious talks

See `LICENSE` for terms. Contributions, corrections, and alternative naming proposals are welcome via pull requests.
